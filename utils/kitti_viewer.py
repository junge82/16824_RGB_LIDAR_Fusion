...
class Object3d(object):
    ''' 3d object label '''
    def __init__(self, label_file_line, from_file=True):
        if from_file:
...
def create_bbox_mesh(p3d, gt_boxes3d, color=(0, 1, 0, 1)):
    b = gt_boxes3d
    for k in range(0,4):
        i,j=k,(k+1)%4
...
def show_lidar_with_boxes(pc_velo: np.ndarray, objects: Object3d, calib: Calibration, preds: Object3d=None):
    ...
    for obj in objects:
        ...
        create_bbox_mesh(p3d, box3d_pts_3d_velo, color=(1, 0, 0, 1))
        # Draw heading arrow
        ori3d_pts_2d, ori3d_pts_3d = compute_orientation_3d(obj, calib.P)
        ori3d_pts_3d_velo = calib.project_rect_to_velo(ori3d_pts_3d)
        x1,y1,z1 = ori3d_pts_3d_velo[0,:]
        x2,y2,z2 = ori3d_pts_3d_velo[1,:]
        p3d.add_line([x1,y1,z1], [x2,y2,z2], color=(1, 0, 0, 1))
    ...
    if preds is not None:
        for obj in preds:
            ...
            box3d_pts_2d, box3d_pts_3d = compute_box_3d(obj, calib.P) 
            box3d_pts_3d_velo = calib.project_rect_to_velo(box3d_pts_3d)
            create_bbox_mesh(p3d, box3d_pts_3d_velo, color=(0, 1, 0, 1))
            # Draw heading arrow
            ori3d_pts_2d, ori3d_pts_3d = compute_orientation_3d(obj, calib.P)
            ori3d_pts_3d_velo = calib.project_rect_to_velo(ori3d_pts_3d)
            x1,y1,z1 = ori3d_pts_3d_velo[0,:]
